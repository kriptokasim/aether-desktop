...
export function onAetherViewCode(callback: (data: any) => void) {
...
export function removeAetherViewCode(callback: (data: any) => void) {
...
export function viewCodeInAether(args: any) {
