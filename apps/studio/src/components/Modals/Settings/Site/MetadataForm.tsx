import type { OGImage, PageMetadata } from '@aether/models';
...
const DEFAULT_DESCRIPTION = 'Generated by Aether';
    ...
    return (
        <div className="text-sm">
            <div className="flex flex-col gap-6 p-6">
                <div className="grid grid-cols-2 text-foreground-aether">
                ...
                <div className="grid grid-cols-2 h-44">
                    <div className="flex flex-col text-foreground-aether col-span-1 max-w-52">
                ...
                <div className="flex flex-col gap-2">
                    <h2 className="text-regular text-foreground-aether">Search Engine Preview</h2>
