        ...
        <div className="flex h-[calc(100vh-2.5rem)]">
            <div className="flex flex-col justify-between w-full h-full max-w-xl p-16 space-y-8 overflow-auto">
                <div className="flex items-center space-x-2">
                    <Icons.AetherTextLogo viewBox="0 0 139 17" />
                </div>
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-foreground-aether text-regular">
                    ...
                    <p className="text-small text-foreground-aether">
                        {t('welcome.terms.agreement')}{' '}
                        <button
                            onClick={() => openExternalLink('https://aether.com/privacy-policy')}
                        ...
                        {t('welcome.terms.and')}{' '}
                        <button
                            onClick={() => openExternalLink('https://aether.com/terms-of-service')}
                            className="text-gray-300 hover:text-gray-50 underline transition-colors duration-200"
                        >
                            {t('welcome.terms.tos')}
                        </button>
